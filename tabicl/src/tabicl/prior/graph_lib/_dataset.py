...
class RandomDataset(PriorComponent):
    def sample(self, data_prop: DatasetProperties) -> Dataset:
        while True:
            ...
            # Stable across processes/PYTHONHASHSEED for reproducible seeded sampling.
            feature_groups = sorted(set(spec.group for spec in data_prop.feature_specs.values()))
